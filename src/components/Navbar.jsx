        ...
        <div className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? ' backdrop-blur-md' : ''}`}>
            <header className={`flex justify-between items-center p-3 transition-all duration-300 ${scrolled ? 'py-2' : 'py-4'}`}>
                ...
                <nav className="hidden md:flex sticky w-full justify-center gap-10 md:gap-20 lg:gap-35 items-center transition-all duration-300">
                    <div className='flex sticky gap-5 lg:gap-10 border-t-2 border-b-2 hover:border-b-0 border-white/20 py-2 group hover:border-pink-500 transition-colors duration-300'>
                    ...
                    <img
                        ...
                        height="70"
                    />
                    <div className='flex gap-5 sticky lg:gap-10 border-t-2 border-b-2 hover:border-b-0 border-white/20 py-2 group hover:border-pink-500 transition-colors duration-300'>
